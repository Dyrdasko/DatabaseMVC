...
namespace DatabaseMVC.Infrastructure.Migrations
{
    ...
    [Migration("20220528231221_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.ContactPerson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Contractor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Headquater", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Kit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Manufacture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.SIMCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Storage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.TypeOfStorage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.CameraDevice", b =>
                {
                    b.HasBaseType("DatabseMVC.Domain.Model.Device");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.RecorderDevice", b =>
                {
                    b.HasBaseType("DatabseMVC.Domain.Model.Device");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.RouterDevice", b =>
                {
                    b.HasBaseType("DatabseMVC.Domain.Model.Device");
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Contractor", b =>
                {
                    b.HasOne("DatabseMVC.Domain.Model.Department", "Department")
                        .WithMany("Contractors")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DatabseMVC.Domain.Model.ContactPerson", "FirstContactPerson")
                        .WithMany("FirstContractor")
                        .HasForeignKey("FirstContactPersonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DatabseMVC.Domain.Model.Headquater", "Headquater")
                        .WithMany("Contractors")
                        .HasForeignKey("HeadquaterId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DatabseMVC.Domain.Model.ContactPerson", "SecondaryContactPerson")
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Device", b =>
                {
                    b.HasOne("DatabseMVC.Domain.Model.Manufacture", "Manufacture")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Kit", b =>
                {
                    b.HasOne("DatabseMVC.Domain.Model.Device", "Device")
                        .WithMany("Kits")
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DatabseMVC.Domain.Model.Order", "Order")
                        .WithMany("Kits")
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Order", b =>
                {
                    b.HasOne("DatabseMVC.Domain.Model.Contractor", "Contractor")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.Storage", b =>
                {
                    ...
                    b.HasOne("DatabseMVC.Domain.Model.TypeOfStorage", "TypeOfStorage")
                        .WithMany("Storages")
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.CameraDevice", b =>
                {
                    b.HasOne("DatabseMVC.Domain.Model.Storage", "Storage")
            ...
            modelBuilder.Entity("DatabseMVC.Domain.Model.RouterDevice", b =>
                {
                    b.HasOne("DatabseMVC.Domain.Model.SIMCard", "SIMCard")
